...
> Para quem está na caixa. Uma página, sem termos técnicos.
...
1. Liga o PC do balcão. O **POS** abre sozinho em ecrã inteiro.
...
Ao finalizar: sai o **talão do cliente**, sai a **comanda da cozinha**, a **gaveta abre** (se houve dinheiro)
e aparece o **número do dia** — é esse número que chamas ao balcão.
...
- **Continua a vender normalmente.** A venda fica guardada no computador.
- O talão e a comanda **saem na mesma** (a impressora está ligada por cabo à loja, não à internet).
- Quando a internet voltar, aparece uma confirmação **verde**: as vendas subiram sozinhas.
- **Não repitas** uma venda porque "parece que não passou" — o sistema não deixa cobrar duas vezes.
